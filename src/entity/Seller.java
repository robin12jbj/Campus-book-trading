...
public class Seller extends User {
    ...
    public Seller(int userId, String userCode) {
     ...
     * @return rowSet
     */
    public CachedRowSetImpl buyCheck(String bookName, String bookType, String bookPress, String bookAuthor) {
        try {
            //link database
     ...
     * @return rowSet
     */
    public boolean addSellMessage(int sellerNo, String bookName, String bookType, String bookPress, String bookAuthor,
                                  String bookPressTime, String messagePressTime, double expectedPrice, String bookDetail, String sellContact) {
        boolean f = false;
        try {
            Jdbcs linkDatabase = new Jdbcs();

            linkDatabase.statement.executeUpdate("insert into sale values(" + null + "," + sellerNo +
